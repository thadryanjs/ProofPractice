...
% Blank line for the student to fill in
\newcommand{\blank}{\par\vspace{2pt}\noindent\textcolor{gray}{\rule{0.96\linewidth}{0.4pt}}\par
  \noindent\textcolor{gray}{\rule{0.96\linewidth}{0.4pt}}\par\vspace{6pt}}
% Shorter single blank
\newcommand{\blankone}{\textcolor{gray}{\rule{0.6\linewidth}{0.4pt}}}
...
\begin{center}
\fbox{\parbox{0.9\linewidth}{\small\textit{Instructions: the structure, equations,
and step labels are given. Fill in the prose in your own words on the blank
lines. If you can explain every blank correctly, you understand the proof.}}}
\end{center}
...
\emph{For each tactic below, write in the margin: is it a} Reshape \emph{or a}
